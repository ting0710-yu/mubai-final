...
{ id: "mochi_milk", name: "鮮奶米麻薯", category: "topping", baseServings: 1, unit: "份", steps: ["材料混合均勻，用小火1600攪拌", "兩分鐘粘稠後關火，放入糯米攪拌均勻"], ingredients: [{ name: "木薯澱粉", amount: 12, unit: "g" }, { name: "砂糖", amount: 9, unit: "g" }, { name: "牛奶", amount: 150, unit: "g" }, { name: "糯米(熟)", amount: 60, unit: "g" }], equipment: "鍋", notes: "不停攪拌", storage: "常溫" },
...
{ id: "sesame_paste", name: "芝麻糊", category: "base", baseServings: 1, unit: "份", steps: ["除了糖外將其他材料放入破壁機中高速打5-8分鐘", "過濾後再加入砂糖放入鍋中加熱", "約五分鐘可糊化"], ingredients: [{ name: "水", amount: 550, unit: "g" }, { name: "熟黑芝麻", amount: 121, unit: "g" }, { name: "糯米粉", amount: 20, unit: "g" }, { name: "砂糖", amount: 22, unit: "g" }], equipment: "破壁機", notes: "現做", storage: "保溫" },
