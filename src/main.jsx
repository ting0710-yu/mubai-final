...
const RECIPES = [
  ...
  { id: "lotus_root", name: "蓮藕片", category: "topping", baseServings: 1, unit: "份", steps: ["蓮藕切片1公分厚，全部材料放入高壓鍋", "有聲音後25分鐘，關火洩氣", "再翻炒收汁約30分鐘", "3200大火煮掉一半水", "轉中火1200煮至粘稠"], ingredients: [{ name: "蓮藕", amount: 1500, unit: "g" }, { name: "砂糖", amount: 270, unit: "g" }, { name: "片紅糖", amount: 210, unit: "g" }, { name: "水", amount: 1500, unit: "g" }], equipment: "高壓鍋", notes: "收汁", storage: "冷藏" },
  { id: "barley", name: "薏仁", category: "topping", baseServings: 1, unit: "份", steps: ["所有材料放置高壓鍋煮", "有聲音後45分鐘", "洩氣瀝乾水"], ingredients: [{ name: "薏仁", amount: 1000, unit: "g" }, { name: "水", amount: 4500, unit: "g" }, { name: "砂糖", amount: 200, unit: "g" }], equipment: "高壓鍋", notes: "閉氣", storage: "瀝乾" },
  ...
  { id: "sweet_potato_chunks", name: "地瓜塊", category: "topping", baseServings: 1, unit: "份", steps: ["放入蒸架、放入鍋中", "水沫過蓮子五公分高", "閉氣煮10分鐘"], ingredients: [{ name: "地瓜", amount: 500, unit: "g" }, { name: "紅片糖", amount: 200, unit: "g" }, { name: "水", amount: 2000, unit: "g" }], equipment: "高壓鍋", notes: "閉氣", storage: "湯保存" },
