...
const RECIPES = [
  ...
  { id: "coconut_milk_base_a", name: "椰奶湯底 A", category: "base", baseServings: 1, unit: "份", steps: ["煮化"], ingredients: [{ name: "水", amount: 120, unit: "g" }, { name: "椰子粉", amount: 50, unit: "g" }, { name: "砂糖", amount: 6, unit: "g" }, { name: "椰漿", amount: 5, unit: "g" }, { name: "牛奶", amount: 20, unit: "g" }], equipment: "鍋", notes: "煮粉", storage: "冷藏" },
  { id: "coconut_milk_base_b", name: "椰奶湯底 B", category: "base", baseServings: 1, unit: "份", steps: ["混合"], ingredients: [{ name: "淡奶油", amount: 90, unit: "g" }, { name: "椰漿", amount: 90, unit: "g" }, { name: "牛奶", amount: 150, unit: "g" }, { name: "旺仔", amount: 200, unit: "g" }, { name: "手工糖漿", amount: 10, unit: "g" }], equipment: "壺", notes: "混合", storage: "冷藏" },
  { id: "milk_tea_base", name: "奶茶湯底", category: "base", baseServings: 1, unit: "份", steps: ["煮茶混合"], ingredients: [{ name: "阿薩姆茶葉", amount: 6, unit: "g" }, { name: "熱水", amount: 300, unit: "g" }, { name: "牛奶", amount: 60, unit: "g" }, { name: "砂糖", amount: 30, unit: "g" }, { name: "黑白淡奶", amount: 70, unit: "g" }, { name: "奶咖", amount: 40, unit: "g" }, { name: "紅糖漿", amount: 20, unit: "g" }], equipment: "壺", notes: "悶泡", storage: "冷藏" },
  { id: "grass_jelly_base", name: "仙草湯底", category: "base", baseServings: 1, unit: "份", steps: ["煮茶混合"], ingredients: [{ name: "阿薩姆茶葉", amount: 6, unit: "g" }, { name: "熱水", amount: 300, unit: "g" }, { name: "牛奶", amount: 60, unit: "g" }, { name: "砂糖", amount: 30, unit: "g" }, { name: "黑白淡奶", amount: 70, unit: "g" }, { name: "奶咖", amount: 40, unit: "g" }, { name: "紅糖漿", amount: 25, unit: "g" }, { name: "仙草汁", amount: 2, unit: "g" }], equipment: "壺", notes: "混合", storage: "冷藏" },
  { id: "coconut_juice_milk", name: "椰汁椰奶", category: "base", baseServings: 1, unit: "份", steps: ["打勻"], ingredients: [{ name: "新鮮椰肉", amount: 120, unit: "g" }, { name: "椰水", amount: 200, unit: "g" }, { name: "水", amount: 100, unit: "g" }, { name: "砂糖", amount: 5, unit: "g" }, { name: "椰漿", amount: 15, unit: "g" }, { name: "牛奶", amount: 40, unit: "g" }, { name: "煉乳", amount: 10, unit: "g" }], equipment: "破壁機", notes: "打勻", storage: "冷藏" },
  { id: "double_skin_milk", name: "雙皮奶", category: "base", baseServings: 1, unit: "份", steps: ["烤"], ingredients: [{ name: "紅皮雞蛋(全蛋)", amount: 125, unit: "g" }, { name: "蛋清", amount: 295, unit: "g" }, { name: "牛奶", amount: 1260, unit: "g" }, { name: "淡奶油", amount: 32.5, unit: "g" }, { name: "砂糖", amount: 75, unit: "g" }], equipment: "烤箱", notes: "烤溫", storage: "冷藏" },
  { id: "double_skin_jelly", name: "雙皮奶凍花", category: "base", baseServings: 1, unit: "份", steps: ["混合"], ingredients: [{ name: "牛奶", amount: 300, unit: "g" }, { name: "砂糖", amount: 30, unit: "g" }, { name: "淡奶油", amount: 120, unit: "g" }, { name: "吉利丁", amount: 10, unit: "g" }], equipment: "鍋", notes: "溫度", storage: "冷凍" },
  { id: "creme_brulee", name: "焦糖布蕾", category: "base", baseServings: 1, unit: "份", steps: ["加熱"], ingredients: [{ name: "牛奶", amount: 400, unit: "g" }, { name: "淡奶油", amount: 400, unit: "g" }, { name: "布丁粉", amount: 100, unit: "g" }], equipment: "鍋", notes: "溫度", storage: "冷藏" },
  { id: "tofu_pudding", name: "豆酪", category: "base", baseServings: 1, unit: "份", steps: ["混合加熱"], ingredients: [{ name: "蒟蒻粉", amount: 48, unit: "g" }, { name: "豆漿粉", amount: 300, unit: "g" }, { name: "熱水", amount: 1680, unit: "g" }, { name: "牛奶", amount: 1080, unit: "g" }, { name: "淡奶油", amount: 180, unit: "g" }, { name: "砂糖", amount: 120, unit: "g" }], equipment: "鍋", notes: "混合", storage: "冷藏" },
  { id: "autumn_pear", name: "秋冬梨", category: "base", baseServings: 1, unit: "份", steps: ["高壓鍋"], ingredients: [{ name: "鴨梨", amount: 9, unit: "顆" }, { name: "黃冰糖", amount: 150, unit: "g" }, { name: "水", amount: 1500, unit: "g" }], equipment: "高壓鍋", notes: "不可回冰", storage: "冷藏" },
  { id: "sesame_paste", name: "芝麻糊", category: "base", baseServings: 1, unit: "份", steps: ["破壁"], ingredients: [{ name: "水", amount: 1100, unit: "g" }, { name: "熟黑芝麻", amount: 120, unit: "g" }, { name: "白糯米", amount: 50, unit: "g" }, { name: "砂糖", amount: 70, unit: "g" }], equipment: "破壁機", notes: "現做", storage: "保溫" },
  { id: "red_bean_paste", name: "紅豆沙", category: "base", baseServings: 1, unit: "份", steps: ["高壓鍋"], ingredients: [{ name: "紅豆", amount: 400, unit: "g" }, { name: "砂糖", amount: 100, unit: "g" }, { name: "水", amount: 2000, unit: "g" }, { name: "檸檬汁", amount: 20, unit: "g" }, { name: "陳皮", amount: 3, unit: "g" }], equipment: "高壓鍋", notes: "綿密", storage: "當天" },
  { id: "water_chestnut", name: "馬蹄沙", category: "base", baseServings: 1, unit: "份", steps: ["煮"], ingredients: [{ name: "馬蹄", amount: 200, unit: "g" }, { name: "水", amount: 750, unit: "g" }, { name: "黃片糖", amount: 150, unit: "g" }, { name: "馬蹄粉", amount: 15, unit: "g" }], equipment: "鍋", notes: "降溫", storage: "冷藏" },
  { id: "aunt_drink", name: "姨媽熱飲", category: "base", baseServings: 1, unit: "份", steps: ["混合"], ingredients: [{ name: "阿薩姆紅茶", amount: 5, unit: "g" }, { name: "熱水", amount: 300, unit: "g" }, { name: "牛奶", amount: 90, unit: "g" }, { name: "奶咖", amount: 25, unit: "g" }, { name: "黑糖漿", amount: 20, unit: "g" }, { name: "薑汁", amount: 10, unit: "g" }], equipment: "鍋", notes: "現點現做", storage: "現做" }
];
             ...
             {isBatchMode ? (
               ...
               <>
                 ...
                 <div className="flex items-center gap-2 mb-2">
                   ...
                   <input type="number" value={targetServings} onChange={(e) => setTargetServings(parseInt(e.target.value) || 0)} className="flex-1 p-2 text-xl font-bold text-center border-2 border-amber-300 rounded-lg focus:outline-none focus:border-amber-500 text-amber-900 bg-white" />
              ...
              <div key={item.id} className="bg-white p-3 rounded-xl border shadow-sm flex flex-col gap-2">
                ...
                <div className="flex justify-end gap-2 items-center">
                   ...
                   {isBulk ? (
                     ...
                     <><button onClick={() => updateStock(item.id, -1, item.name, item.unit)} className="bg-stone-100 w-8 h-8 rounded flex items-center justify-center font-bold">-1</button><button onClick={() => updateStock(item.id, 1, item.name, item.unit)} className="bg-amber-100 w-8 h-8 rounded text-amber-800 flex items-center justify-center font-bold">+1</button></>
                   ) : (
      ...
      <div className="space-y-3">
        {QA_DATA.map((item, idx) => (
          <div key={idx} className="bg-white border border-stone-100 rounded-xl shadow-sm overflow-hidden">
            <button onClick={() => setOpenIndex(openIndex === idx ? null : idx)} className="w-full text-left p-4 flex justify-between items-center bg-white hover:bg-stone-50 transition"><span className="font-bold text-stone-700 flex gap-2"><span className="text-amber-500">Q.</span>{item.q}</span><span className={`transform transition-transform ${openIndex === idx ? 'rotate-180' : ''}`}>▼</span></button>
